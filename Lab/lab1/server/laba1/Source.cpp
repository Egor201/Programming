...
void gen_response1(const Request& req, Response& res) {
    ...
    auto clientWeather = cli1.Get("/data/2.5/onecall?lat=44.5653&lon=34.0615&lang=ru&units=metric&exclude=current,minutely,daily,alerts&appid=f2e54dfdba823ccb93bd7881406de63b");
    if (clientTime) {
